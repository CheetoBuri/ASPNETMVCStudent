...
namespace StudentApp.Controllers
{
    public class SchoolStudentController : Controller
    {
        ...
        // GET: SchoolStudent/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SchoolStudent/Create
